...
function LandingSection() {
  return (
    <section className="landing-section lg:p-8 w-auto p-8 bg-primary text-primary">
      <div className="intro text-center flex items-center flex-col">
        <h1 className="text-4xl font-bold mb-4">{"I'm Steven Bui"}</h1>
        <p className="mb-8">
          I am a 3rd year student @ The University of Melbourne, a full-stack web developer. I am also a low-level
          programming, AI Enthusiast
        </p>
        <div className="quick-links grid md:flex justify-center md:auto-cols-max md:w-full grid-flow-row w-4/5">
          <a
            href="/ProjectAssets/Duc Bui - Resume.docx"
            download
            className="btn bg-blue-500 text-white py-2 px-4 rounded-full flex justify-center gap-2 items-center w-full md:w-auto m-2 md:m-4"
          >
          ...
          <a
            ...
            className="btn w-full md:w-auto bg-blue-700 text-white py-2 px-4 m-2 md:m-4 rounded-full flex justify-center gap-2 items-center"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn w-full md:w-auto bg-gray-800 text-white py-2 px-4 m-2 md:m-4 rounded-full flex justify-center gap-2 items-center"
          >
            <FaGithub className="" /> GitHub
          </a>
          <a
            href="mailto:steven.bui0810@gmail.com"
            className="btn bg-red-500 md:w-auto text-white py-2 px-4 m-2 md:m-4 rounded-full flex justify-center gap-2 items-center w-full"
          >
...
function ProjectSection(props: any) {
  ...
  return (
    <section className="project-section bg-gray-100 py-12 h-100vh bg-nav-primary text-primary">
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <Card
              key={index}
              className="bg-primary text-primary border-none rounded-lg shadow-lg overflow-hidden md:m-4 m-4 transform transition duration-500 hover:scale-105"
            >
              <CardHeader>
                <Image
                  src={project.image}
                ...
                <div className="flex flex-col justify-center">
                  <div className="flex flex-row justify-center gap-2 my-4">
                    {project.technologies.map((tech, index) => (
                      <span
                        key={index}
                        className="bg-blue-200 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded h-fit"
                      >
                        {tech}
                      </span>
                    ))}
