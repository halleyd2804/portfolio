...
import { SelectContent, SelectItem, SelectTrigger, SelectValue, SelectLabel } from '@/components/ui/select'; 
        ...
        <div className="p-4 bg-white h-screen">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {projectsData.map((project,idx) => (
                    <Card key={idx} className="bg-white rounded-lg shadow-lg overflow-hidden md:m-4 m-4 transform transition duration-500 hover:scale-105 text-center">
                    <CardHeader>
